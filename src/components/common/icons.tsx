...
export function IconFlame(props: IconProps) {
  return (
    <svg {...base(props)}>
      <path d="M12 3c2 3 1 5 1 7a3 3 0 0 0 6 0c0 5-3 9-7 9s-7-4-7-9c0-2 2-5 4-7 0 2 1 3 3 3z" />
    </svg>
  );
}
...
export function IconShirt(props: IconProps) {
  return (
    <svg {...base(props)}>
      <path d="M8 4 4 7v4l3 1v8h10v-8l3-1V7l-4-3-2 2h-2L8 4z" />
    </svg>
  );
}
...
export function IconFace(props: IconProps) {
  return (
    <svg {...base(props)}>
      <circle cx="12" cy="12" r="9" />
      <path d="M9 10h.01M15 10h.01M8.5 15c1 1.2 2.5 1.8 3.5 1.8s2.5-.6 3.5-1.8" />
    </svg>
  );
}
